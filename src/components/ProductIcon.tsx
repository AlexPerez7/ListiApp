...
const ICONS: Record<string, ReactElement> = {
  ...
  citrus: (
    <>
      ...
      <circle cx="12" cy="13" r="6.5" fill="none" stroke="#e08e0b" strokeWidth="1" />
  ...
  avocado: (
    <>
      <path d="M12 20.5c-3.3 0-5.5-3-5.5-6.8C6.5 9.5 9 6 12 6s5.5 3.5 5.5 7.7c0 3.8-2.2 6.8-5.5 6.8Z" fill="#7fae4a" />
      <circle cx="12" cy="15" r="3" fill="#8a5a34" />
    </>
  ),
  tomato: (
    <>
  ...
  onion: (
    <>
      ...
      <path d="M12 6.5v13.3" stroke="#b9a0cc" strokeWidth="0.8" />
  ...
  leafy: (
    <>
      ...
      <path d="M12 20V10" stroke="#4c7a2b" strokeWidth="1" />
    </>
  ),
  cucumber: (
    <path
      d="M5.5 13.2c-.6-.6-.6-1.6 0-2.2L11 5.5c.6-.6 1.6-.6 2.2 0l5.3 5.3c.6.6.6 1.6 0 2.2l-5.5 5.5c-.6.6-1.6.6-2.2 0Z"
      fill="#7fae4a"
    />
  ),
  corn: (
  ...
  garlic: (
    <>
      ...
      <path d="M12 6.5v13" stroke="#d8cdb5" strokeWidth="0.8" />
    </>
  ),
  pepper: (
    <>
  ...
  meat: (
    <>
      ...
      <path d="M13.5 9c1.5 1.2 1.7 3.3.5 5" stroke="#f2b9ae" strokeWidth="1" fill="none" strokeLinecap="round" />
    </>
  ),
  chicken: (
    <>
  ...
  ham: (
    <>
      ...
      <circle cx="12" cy="13" r="7" fill="none" stroke="#d4707c" strokeWidth="1" strokeDasharray="1.5 2" />
    </>
  ),
  burger: (
    <>
  ...
  butter: (
    <rect x="5" y="9" width="14" height="9" rx="1.5" fill="#f7d95c" stroke="#e0bd2e" strokeWidth="0.6" />
  ),
  bread: (
    <path
  ...
  rice: (
    <>
      <path d="M5 15c0-4 3-6.5 7-6.5s7 2.5 7 6.5-2 5-7 5-7-1-7-5Z" fill="#f5f5f0" stroke="#ddd8c8" strokeWidth="0.6" />
    </>
  ),
  pasta: (
    <path
  ...
  flour: (
    <path d="M7 6h10l1 12.5c0 .8-.7 1.5-1.5 1.5h-9c-.8 0-1.5-.7-1.5-1.5Z" fill="#f7f3e8" stroke="#ddd6c0" strokeWidth="0.6" />
  ),
  sugarSalt: (
    <path d="M9 5h6l3 13.5c.1.8-.5 1.5-1.3 1.5H7.3c-.8 0-1.4-.7-1.3-1.5Z" fill="#f2f2f2" stroke="#dcdcdc" strokeWidth="0.6" />
  ),
  condiment: (
    <path
  ...
  tea: (
    <>
      <path d="M6 11h9v4.5c0 2-1.6 3.5-3.5 3.5h-2C7.6 19 6 17.5 6 15.5Z" fill="#8fae5c" />
  ...
  soda: (
    <path d="M8 6h8l-.8 13.2c0 .7-.6 1.3-1.3 1.3H10c-.7 0-1.3-.6-1.3-1.3Z" fill="#e0433f" />
  ),
  juice: (
    <path d="M8 6h8v12.5c0 .8-.7 1.5-1.5 1.5h-5c-.8 0-1.5-.7-1.5-1.5Z" fill="#f28c28" />
  ),
  beer: (
    <>
  ...
  ice: (
    <path d="M7 7h10v10H7Z" fill="#cdeaf7" stroke="#a9d8ee" strokeWidth="0.7" />
  ),
  cleaning: (
    <>
  ...
  diaper: (
    <path
      d="M5 9h14c0 4-2 8-7 8s-7-4-7-8Z"
      fill="#bfe3f2"
    />
  ),
}
